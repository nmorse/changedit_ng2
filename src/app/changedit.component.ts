...
export class ChangeditAppComponent {
  ...
  initState() {
    return new FSM(
      {"states":{"Start":{},"clean":{},"editing":{},"changed":{onEnterState:function(){return this.diff_display = this.diffEngine.diffString(this.original_item, this.new_item);}},"to-be-removed":{}},"trans":{"Start":{"init":{"clean":true}},"clean":{"edit":{"editing":true},"remove":{"to-be-removed":true}},"editing":{"revert":{"clean":true},"accept":{"changed":true,"clean":function () { return (this.original_item == this.new_item);}}},"changed":{"revert":{"clean":true},"edit":{"editing":true}},"to-be-removed":{"revert":{"clean":true}}},"current_state_name":"Start","views":[{"name":"primary","nodes":{}},{"name":"kitty corner","nodes":{"Start":{"position":{"x":300,"y":70},"width":60}}}]}
      , {"logging": true}
    );
  }
